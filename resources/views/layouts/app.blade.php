...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{url('/images/logo.jfif')}}" />
    ...
    <link rel="stylesheet" href="{{asset('admin_assets/assets/css/toastr.css')}}">
...
background-image: linear-gradient(315deg, #acabb0 10%, #960e1c 74%);">
    @yield('content')
    ...
    <script src="{{asset('admin_assets/assets/js/toastr.js')}}"></script>
