            ...
            <table class="table table-striped  table-hover pt-3 ">
                           ...
                           <div class="row justify-content-end p-2 mb-2">
                            <div class="col-4">
                                <select name="filter" class="form-select" onchange="document.getElementById('search-form').submit()">
                                    ...
                                    <option value="admin" {{request()->query('filter')=='admin'?'selected':''}}>Admin</option>
                                    <option value="time" {{request()->query('filter')=='time'?'selected':''}}>Time</option>
                                </select>
                            </div>
                               <div class="col-5 p-0">
                ...
                <thead class="">
                  <tr>
                    ...
                    <th scope="col" class="text-center">Released By</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if ($item?->lockin_days==$item?->days_count)
